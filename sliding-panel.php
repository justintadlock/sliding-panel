...
final class Sliding_Panel_Plugin {
	...
	public function enqueue_scripts() {
		...
		if ( is_active_sidebar( 'sliding-panel' ) ) {
			...
			wp_register_script( 'sliding-panel', "{$this->directory_uri}panel.js", array( 'jquery' ), '0.1', true );
			...
			wp_enqueue_style( 'sliding-panel', "{$this->directory_uri}panel.css", false, 0.1, 'screen' );
		}
	}
